...
var stylesheetID = 'zotero-folder-map-stylesheet'
var ftlID = 'zotero-folder-map-ftl'
...
async function startup({ id, version, resourceURI, rootURI = resourceURI.spec }) {
  ...
  if (win && win.ZoteroPane) {
    ...
    link2.href = 'zotero-folder-map.ftl'
    ...
    menuitem.addEventListener('command', () => {
      Zotero.FolderMap.toggleGreen(menuitem.getAttribute('checked') === 'true')
    })
